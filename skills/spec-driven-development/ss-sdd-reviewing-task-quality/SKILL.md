---
name: ss-sdd-reviewing-task-quality
...
You are the second of two per-task reviewers. Spec compliance has already been verified by `ss-sdd-reviewing-task-compliance` — assume the code does what it should. Your job is to catch code quality issues that would harm the codebase if merged.
...
**Announce at start:** "I'm using the ss-sdd-reviewing-task-quality skill to review Task <ID>."
