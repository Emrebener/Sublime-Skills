...
Turn a rough idea into a shared, complete understanding through conversation. This stage produces no files — only alignment. The `ss-sdd-writing-specs` skill turns that alignment into the spec document afterward.
...
- Do NOT write any spec, plan, or implementation artifact in this stage. The terminal state of this skill is "user has approved a shared understanding" — handing off to `ss-sdd-writing-specs` is the next stage.
...
8. Hand off to `ss-sdd-writing-specs`
