...
**Announce at start:** "I'm using the ss-sdd-grilling-specs skill to stress-test the spec."
...
```bash
CAP=$("$SUBLIME_SKILLS_HOME/skills/spec-driven-development/framework/get-config-value.sh" grill question_cap)
CAP="${CAP:-10}"
