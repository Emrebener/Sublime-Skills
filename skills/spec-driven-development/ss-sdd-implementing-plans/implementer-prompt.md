...
Use the `ss-sdd-implementing-task` skill before you begin. It tells you the protocol for this role.
...
5. Self-review (see Self-Review section in the `ss-sdd-implementing-task` skill)
...
See the `ss-sdd-implementing-task` skill's "Surface Unclear Things Before You Begin" section for the exact format.
