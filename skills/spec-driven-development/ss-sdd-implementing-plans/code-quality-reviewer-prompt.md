...
The detailed protocol lives in the `ss-sdd-reviewing-task-quality` skill — this prompt just wraps the dispatch.
...
Use the `ss-sdd-reviewing-task-quality` skill before you begin. It is your full protocol — what you check, severity rubric, output format, common mistakes, red flags.
...
The exact output format defined in the `ss-sdd-reviewing-task-quality` skill (Status: Approved | Issues Found; findings grouped Critical / Important / Minor; 2-3 sentence summary).
```
