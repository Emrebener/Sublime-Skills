...
The detailed protocol lives in the `ss-sdd-reviewing-task-compliance` skill — this prompt just wraps the dispatch.
...
Use the `ss-sdd-reviewing-task-compliance` skill before you begin. It is your full protocol — checks, calibration, output format, common mistakes, red flags.
...
The exact output format defined in the `ss-sdd-reviewing-task-compliance` skill (Status: Approved | Issues Found; categorized findings; verification of re-run tests; 2-3 sentence summary).
```
