...
until [ -f ~/.cache/ss-web-browser-tools/sessions/default/dialog-armed ]; do sleep 0.1; done
...
`~/.cache/ss-web-browser-tools/sessions/<session>/dialog-armed`.
