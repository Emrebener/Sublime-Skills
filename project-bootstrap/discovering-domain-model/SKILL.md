...
**Announce at start:** "I'm using the discovering-domain-model skill to build docs/DOMAIN.md with you."
...
So this skill stays inline. It scans the code itself, then talks to the user about which entities matter and how they really behave. The four sibling skills (`discovering-constitution`, `discovering-architecture`, `discovering-glossary`, `discovering-design`) follow the same pattern for the same reason.
