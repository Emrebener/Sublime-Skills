...
**Announce at start:** "I'm using the discovering-constitution skill to build docs/constitution.md with you."
...
So this skill stays inline. It scans the code itself, then talks to the user directly about the principles the code can't reveal. The four sibling skills (`discovering-architecture`, `discovering-glossary`, `discovering-domain-model`, `discovering-design`) follow the same pattern for the same reason.
